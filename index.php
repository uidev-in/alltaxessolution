...
<html>
	<head>
		...
		<!-- Title Tag  -->
        <title>All Taxes Solution</title>
	...
	<body id="bg">
		...
		<section class="hero-slider style1">
			<div class="home-slider">
				<!-- Single Slider -->
				<div class="single-slider" style="background-image:url('img/slide-1.jpg')">
					<div class="container">
						<div class="row">
								...
								<div class="welcome-text"> 
									<div class="hero-text"> 
										...
										<div class="button">
											...
											<a href="portfolio.html" class="bizwheel-btn theme-2 effect">Read More</a>
										</div>
									</div>
								</div>
							</div>
				...
				<!--/ End Single Slider -->
				<!-- Single Slider -->
				<div class="single-slider" style="background-image:url('img/slide-2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-8 col-12">
							<div class="welcome-text"> 
				...
				<!--/ End Single Slider -->
				<!-- Single Slider -->
				<div class="single-slider" style="background-image:url('img/slide-3.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-8 col-12">
							<div class="welcome-text"> 
					...
					<div class="col-12">
						<div class="section-title style2 text-center">
							<div class="section-top">
								<h1><b>Why Choose Us?</b></h1><h4>We provide quality service &amp; support..</h4>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="section-title style2 text-center">
							<div class="section-top">
								<h1><b>Service We Provide</b></h1><h4>We provide quality service &amp; support..</h4>
							</div>
							<!-- <div class="section-bottom">
								<div class="text-style-two">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-service">
							<div class="service-head">
								<img src="img/GST-Services.jpg" alt="#">
					...
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-service">
							<div class="service-head">
								<img src="img/COMPANY-REGISTERATION-SERVICES.jpg" alt="#">
								<div class="icon-bg"><i class="fa fa-handshake-o"></i></div>
							</div>
							<div class="service-content">
					...
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-service">
							<div class="service-head">
								<img src="img/TRADEMARK-REGISTERATION-SERVICES.jpg" alt="#">
								<div class="icon-bg"><i class="fa fa-handshake-o"></i></div>
							</div>
							<div class="service-content">
                ...
                <div class="row">
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-service">
							<div class="service-head">
								<img src="img/FOOD-LICENSE-SERVICES.jpg" alt="#">
								<div class="icon-bg"><i class="fa fa-handshake-o"></i></div>
							</div>
							<div class="service-content">
								<h4><a href="#">FOOD LICENSE</a></h4>
								<p>Cras venenatis, purus sit amet tempus mattis, justo nisi facilisis metus, in tempus ipsum ipsum eu ipsum. Class aptent taciti</p>
								<a class="btn" href="#"><i class="fa fa-arrow-circle-o-right"></i>View Service</a>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-service">
							<div class="service-head">
								<img src="img/INCOME-TAX-RETURN-SERVICES.jpg" alt="#">
								<div class="icon-bg"><i class="fa fa-handshake-o"></i></div>
							</div>
							<div class="service-content">
								<h4><a href="#">INCOME TAX RETURN</a></h4>
								<p>Cras venenatis, purus sit amet tempus mattis, justo nisi facilisis metus, in tempus ipsum ipsum eu ipsum. Class aptent taciti</p>
								<a class="btn" href="#"><i class="fa fa-arrow-circle-o-right"></i>View Service</a>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-4 col-12">
						...
						<div class="single-service">
							<div class="service-head">
								<img src="img/TDS-SERVICES.jpg" alt="#">
								<div class="icon-bg"><i class="fa fa-handshake-o"></i></div>
							</div>
							<div class="service-content">
								<h4><a href="#">TDS RETURN</a></h4>
								<p>Cras venenatis, purus sit amet tempus mattis, justo nisi facilisis metus, in tempus ipsum ipsum eu ipsum. Class aptent taciti</p>
								<a class="btn" href="#"><i class="fa fa-arrow-circle-o-right"></i>View Service</a>
							</div>
						</div>
		...
		<!-- Testimonials -->
		<section class="testimonials section-space" style="background-image:url('img/testimonial-bg-image.jpg')">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-9 col-12">
						<div class="section-title default text-left">
							<div class="section-top">
								<h1><b>Our Happy Clients</b></h1>
							</div>
							<div class="section-bottom">
